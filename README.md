...
```shell
git clone git@github.com:pubkeyapp/pubkey-resolver.git
cd pubkey-resolver
pnpm
```
...
```shell
> NX Generating @pubkey-resolver/tools:prisma-model
...
```shell
> NX Generating @pubkey-resolver/tools:api-feature
...
```shell
> NX Generating @pubkey-resolver/tools:web-feature
