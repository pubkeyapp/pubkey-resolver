...
const clusterAtom = atomWithStorage<Cluster>('pubkey-resolver-cluster', defaultClusters[0])
const clustersAtom = atomWithStorage<Cluster[]>('pubkey-resolver-clusters', defaultClusters)
