...
import { RegisterInput } from '@pubkey-resolver/sdk'
import { useAuth } from '@pubkey-resolver/web-auth-data-access'
import { AuthUiForm, AuthUiFull, AuthUiShell } from '@pubkey-resolver/web-auth-ui'
import { useAppConfig } from '@pubkey-resolver/web-core-data-access'
